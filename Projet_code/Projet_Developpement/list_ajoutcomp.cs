...
{
    public partial class list_ajoutcomp : Form
    {
        private GRHProjectEntities1 bd;
        public int actualiser = 0;

        public list_ajoutcomp(GRHProjectEntities1 p_bd)
        {
            InitializeComponent();
            bd = p_bd;
            bs.DataSource = bd.COMPETENCE;
        ...
        private void list_ajoutcomp_FormClosing(object sender, FormClosingEventArgs e)
        {
            bs.EndEdit();
            bd.SaveChanges();
            actualiser = 1;
